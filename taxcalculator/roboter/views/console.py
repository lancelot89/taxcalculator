...
def find_tamplate(temp_file):
    template_dir_file_path = get_template_dir_path()
    temp_file_path = os.path.join(template_dir_file_path, temp_file)
...
def get_template(template_file_path, color=None):
    template = find_tamplate(template_file_path)
